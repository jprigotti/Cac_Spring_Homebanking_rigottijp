...
public class AccountController {
    ...
    public AccountController (AccountService service, TypeAccountService typeAccountService, UserService userService, AccountRepository accountRepository, TransferRepository transferRepository) {
...
//        int user_id = parseInt(accountDto.getUserId());
    ...
    public String transfer(@ModelAttribute("accountDto") AccountDto accountDto, Model model){
        ...
        Transfer transfer = new Transfer(sourceAccountId, destinationAccount.getAccount_id(), transferAmount);
